          ...
          <div className="w-full max-w-[420px] mx-auto space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div
                ...
                style={{ animationDelay: "0.3s", animationFillMode: "both" }}
              >
                <div className="flex h-[78px] flex-col justify-center rounded-xl border border-gray-200 dark:border-surface-700 px-4 shadow-sm focus-within:border-brand-500 focus-within:ring-2 focus-within:ring-brand-500/20 transition-all duration-200">
                  <label htmlFor="login-email" className="text-gray-500 dark:text-gray-400 text-sm">
                    {t("auth.email")}
                  </label>
                  <input
                    id="login-email"
              ...
              >
                <div className="flex h-[78px] flex-col justify-center rounded-xl border border-gray-200 dark:border-surface-700 px-4 shadow-sm focus-within:border-brand-500 focus-within:ring-2 focus-within:ring-brand-500/20 transition-all duration-200">
                  <label htmlFor="login-password" className="text-gray-500 dark:text-gray-400 text-sm">
                    {t("auth.password")}
                  </label>
                  <input
                    id="login-password"
              ...
              >
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-[66px] bg-brand-700 hover:bg-brand-800 text-white font-semibold rounded-full transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-2 hover:shadow-glow"
                >
                  {isLoading ? (
